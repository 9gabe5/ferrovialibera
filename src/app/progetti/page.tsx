...
const progetti = [
  ...
  {
    emoji: "💬", titolo: "La Gente di FerroViaLibera",
  ...
  {
    emoji: "🗣️", titolo: "Sensibilizzare sul linguaggio",
  ...
  {
    emoji: "🤝", titolo: "Riunioni Associative",
        ...
        {progetti.map((p) => (
          <article key={p.titolo} className="border border-gray-200 bg-white flex flex-col">
            ...
            <div className="p-5 flex flex-col flex-1">
              <h2 className="font-display font-bold text-xl text-accento"><span aria-hidden="true">{p.emoji}</span> {p.titolo}</h2>
